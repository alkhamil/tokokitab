...
class Banner_model extends CI_Model {
    ...
    public $primary_key = 'm_banner.id';
    public $order_by = 'm_banner.id';
    public $order_type = 'DESC';
    public $search_field = 'm_banner.id';
    public $column_order = ['m_banner.id'];
    public $column_search = ['m_banner.id'];
