...
class Order_detail_model extends CI_Model {
    ...
    public $primary_key = 't_order_detail.id';
    public $order_by = 't_order_detail.id';
    public $order_type = 'DESC';
    public $search_field = 't_order_detail.id';
    public $column_order = ['t_order_detail.id'];
    public $column_search = ['t_order_detail.id'];
