...
class Invoice_model extends CI_Model {
    ...
    public $primary_key = 't_invoice.id';
    public $order_by = 't_invoice.id';
    public $order_type = 'DESC';
    public $search_field = 't_invoice.code';
    public $column_order = ['t_invoice.code'];
    public $column_search = ['t_invoice.code'];
